# A Case Study Comparing ML with Statistical Methods for TS Forecasting
...
| **Venue** | [VENUE] |
| **DOI/URL** | [DOI_URL] |
| **Original Code** | https://github.com/vcerqueira/experiments-sizematters |
...
```bash
cd experiments/007_ml_vs_statistical_ts/
python3 -m venv .venv
