...
from src.workflows.modeling import SensitivityOnSampling
...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'assets/results/sensitivity')
