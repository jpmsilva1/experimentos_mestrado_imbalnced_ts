# Instance-Based Meta-Learning for Selecting Forecasting Models
...
| **Venue** | [VENUE] |
| **DOI/URL** | [DOI_URL] |
| **Original Code** | https://github.com/vcerqueira/metaforecast |
...
```bash
cd experiments/016_metaforecast_instance_based/
python3 -m venv .venv
...
```
016_metaforecast_instance_based/
├── README.md              ← This file
