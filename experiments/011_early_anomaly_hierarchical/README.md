# Early Anomaly Detection: Hierarchical Approach for Critical Health Episodes
...
| **Venue** | [VENUE] |
| **DOI/URL** | [DOI_URL] |
| **Original Code** | https://github.com/vcerqueira/experiments-layered_learning |
...
```bash
cd experiments/011_early_anomaly_hierarchical/
python3 -m venv .venv
...
```
011_early_anomaly_hierarchical/
├── README.md              ← This file
