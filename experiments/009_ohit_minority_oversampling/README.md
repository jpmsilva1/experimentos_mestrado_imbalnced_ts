# Minority Oversampling for Imbalanced Time Series Classification (OHIT)
...
| **Venue** | [VENUE] |
| **DOI/URL** | [DOI_URL] |
| **Original Code** | https://github.com/zhutuanfei/OHIT |
...
```bash
cd experiments/009_ohit_minority_oversampling/
python3 -m venv .venv
...
```
009_ohit_minority_oversampling/
├── README.md              ← This file
