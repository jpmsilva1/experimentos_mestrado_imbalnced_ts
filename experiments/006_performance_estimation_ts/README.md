# Evaluating Time Series Forecasting Models: Performance Estimation Methods
...
| **Venue** | [VENUE] |
| **DOI/URL** | [DOI_URL] |
| **Original Code** | https://github.com/vcerqueira/experiments-performance_estimation |
...
```bash
cd experiments/006_performance_estimation_ts/
python3 -m venv .venv
