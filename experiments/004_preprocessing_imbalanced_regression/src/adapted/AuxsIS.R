...
WFoutput <- function(ids, trues, preds) {
  list(trues = trues, preds = preds)
}
...
WFRU <- function(form, train, test, learner, rel=rel, thr.rel=thr.rel, C.perc=C.perc, ...){
...
WFRO <- function(form, train, test, learner, rel=rel, thr.rel=thr.rel, C.perc=C.perc, ...){
...
WFGN <- function(form, train, test, learner, rel, thr.rel, C.perc, pert, ...){
